...
<?php esc_html_e( 'Skip to content', 'newsup' ); ?></a>
    <div class="wrapper" id="custom-background-css">
        <header class="mg-headwidget">
            ...
            <div class="mg-nav-widget-area-back" style='height:140px; background-image: url("<?php echo esc_url( $background_image ); ?>" );'>
...
<?php $show_popular_tags_title = newsup_get_option('show_popular_tags_title');
 ...
 <div class="modal fade" id="Splash" tabindex="-1" role="dialog">
	<div class="modal-dialog mt-5">
      ...
      <?php $image = get_theme_support( 'custom-header', 'default-splash' ); ?>
			<img src="<?php echo esc_url( $image ); ?>" alt="Aniversario MINAGUAS">
		</div>
	</div>
</div>